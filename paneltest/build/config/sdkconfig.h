...
#define CONFIG_MV_PANEL_ILI9341 1
#define CONFIG_MV_LCD_PCLK_MHZ 40
#define CONFIG_MV_LCD_SWAP_XY 1
#define CONFIG_MV_LCD_MIRROR_X 1
#define CONFIG_MV_LCD_BGR 1
